...
ActiveRecord::Schema.define(version: 2021_01_14_060852) do
  ...
  create_table "order_sources", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  add_foreign_key "order_sources", "orders"
